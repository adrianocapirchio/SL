...
lin_idx_p_value = round(stats.f_oneway(meanNormalAllReachingsLinIdx,meanAtaxiaAllReachingsLinIdx)[1],5)
lin_idx_fisher = round(stats.f_oneway(meanNormalAllReachingsLinIdx,meanAtaxiaAllReachingsLinIdx)[0],5)
...
asy_idx_p_value = round(stats.f_oneway(meanNormalAllReachingsAsyIdx,meanAtaxiaAllReachingsAsyIdx)[1],5)
asy_idx_fisher = round(stats.f_oneway(meanNormalAllReachingsAsyIdx,meanAtaxiaAllReachingsAsyIdx)[0],5)
...
smo_idx_p_value = round(stats.f_oneway(meanNormalAllReachingsSmoIdx,meanAtaxiaAllReachingsAsyIdx)[1],5)
smo_idx_fisher = round(stats.f_oneway(meanNormalAllReachingsSmoIdx,meanAtaxiaAllReachingsAsyIdx)[0],5)
